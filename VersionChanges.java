...
public class VersionChanges {
	...
	private void initalisePatch0_0() {
		...
		this.patchNotes[0][2]="ver 0.0.2\ncommands: psctcaps should be finished, asside from checking named types of counters";
		...
		this.patchNotes[0][8]="ver 0.0.8\n"
				...
				+ "j!effectdecteion no longer messes up ``` useage if a single effect generated a message over 2000 characters in length\n"
