...
public class SubCommandHelp extends Command {
	...
	private String temp="All subcommands are prefixed with \"$$\".\n\n"
			...
			+ "(name/card/arch) {card/archetype name} $$end: Tells spellcheck what card/archetype name(s) your cards have, and checks them for spelling. Case sensitive. "
			;
	...
	SubCommandHelp()
	{
		this.name="subcommandhelp";
		this.help="Lists all avaliable subcommands and explains their use";
